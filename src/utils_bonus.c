...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/05 18:56:13 by blucken           #+#    #+#             */
 ...
 * 
 * This function searches for the PATH environment variable and splits it into 
 * an array of paths.
 * 
 ...
 * 
 * This function frees the memory allocated for the paths array and returns the 
 * specified path.
 * 
 ...
 * 
 * This function closes all pipes and frees the memory allocated for the pipes 
 * array.
 * 
 ...
 * 
 * This function prints an error message for bad arguments and returns the 
 * specified value.
 * 
